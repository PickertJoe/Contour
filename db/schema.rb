...
ActiveRecord::Schema.define(version: 2022_01_01_230028) do
  ...
  create_table "elevation_graphs", force: :cascade do |t|
  ...
  create_table "gpx_data", force: :cascade do |t|
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.integer "gpx_id"
    t.bigint "time", default: [], array: true
    t.bigint "elevation", default: [], array: true
  end
